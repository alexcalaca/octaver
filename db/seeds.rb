...
Instrument.create!([{
  title: "Paul Reed Smith Guitar 2013",
  brand: "PRS",
...
{
  title: "2017 Gibson Les Paul Standard Bourbon Burst 100 percent Mint and Unplayed Condition",
  brand: "Gibson",
...
{
  title: "Ibanez PM20 Pat Metheny Signature plus Hard Shell case",
  brand: "Ibanez",
  model: "SG",
